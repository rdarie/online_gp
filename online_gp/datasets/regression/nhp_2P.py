...
class NHP_2P(object):
    def __init__(
        ...
        if dataset_name is None:
            raise ValueError("Argument 'dataset_name' cannot be empty")
        else:
    ...
    def _preprocess(self, subsample_ratio, test_ratio, split_seed):
        file_path = os.path.join(self.dataset_dir, f'{self.dataset_name}.parquet')
        # TODO load the data
        ...
        # TODO turn the lfp target into a scalar
